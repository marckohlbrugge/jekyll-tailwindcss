...
#  jekyll-tailwindcss-1.x.x-x86_64-linux.gem:
#
#     exe/
#     ├── tailwindcss
#     └── x86_64-linux/
...
#
#  - pkg/jekyll-tailwindcss-1.0.0.gem
#  - pkg/jekyll-tailwindcss-1.0.0-aarch64-linux.gem
#  - pkg/jekyll-tailwindcss-1.0.0-arm64-darwin.gem
#  - pkg/jekyll-tailwindcss-1.0.0-x64-mingw32.gem
#  - pkg/jekyll-tailwindcss-1.0.0-x64-mingw-ucrt.gem
#  - pkg/jekyll-tailwindcss-1.0.0-x86_64-darwin.gem
#  - pkg/jekyll-tailwindcss-1.0.0-x86_64-linux.gem
#
...
Tailwindcss::Upstream::NATIVE_PLATFORMS.each do |platform, filename|
  JEKYLL_TAILWINDCSS_GEMSPEC.dup.tap do |gemspec|
